...
def plot_prediction(
    ...
    # Plot training data
    plt.scatter(
        train_data, train_labels, color="blue", s=4, label="Training data"
    )

    # Plot test data
    plt.scatter(
        test_data, test_labels, color="green", s=4, label="Testing data"
    )

    # Plot prediction
    if prediction is not None:
        plt.scatter(
            test_data, prediction, color="red", s=4, label="Predictions"
        )
